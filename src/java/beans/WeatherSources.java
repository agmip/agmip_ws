...
@XmlRootElement
public class WeatherSources implements Serializable {
	...
	public WeatherSources(Integer wid) {
		this.wid = wid;
	}
	...
	public boolean equals(Object object) {
		...
		if (!(object instanceof WeatherSources)) {
			return false;
		}
		WeatherSources other = (WeatherSources) object;
