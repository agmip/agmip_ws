...
public class OrganicMaterialLevelResource {
    ...
    /**
     * Get method for retrieving an instance of OrganicMaterialLevel identified by id in XML format.
     *
    ...
    /**
     * Put method for updating an instance of OrganicMaterialLevel identified by id using XML as the input format.
     *
     * @param id identifier for the entity
    ...
    /**
     * Delete method for deleting an instance of OrganicMaterialLevel identified by id.
     *
     * @param id identifier for the entity
     */
    @DELETE
    ...
    /**
     * Returns an instance of OrganicMaterialLevel identified by id.
     *
     * @param id identifier for the entity
     * @return an instance of OrganicMaterialLevel
     */
    protected OrganicMaterialLevel getEntity() {
        ...
        try {
            ...
            return (OrganicMaterialLevel) em.createQuery("SELECT e FROM OrganicMaterialLevel e where e.organicMaterialLevelsPK = :organicMaterialLevelsPK").setParameter("organicMaterialLevelsPK", id).getSingleResult();
