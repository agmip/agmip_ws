...
public class PlantingsResource {
    ...
    /**
     * Get method for retrieving an instance of Plantings identified by id in XML format.
     *
    ...
    public PlantingsConverter get(@QueryParam("expandLevel")
            @DefaultValue("1") int expandLevel) {
        PersistenceService persistenceSvc = PersistenceService.getInstance();
        try {
            persistenceSvc.beginTx();
            return new PlantingsConverter(getEntity(), uriInfo.getAbsolutePath(), expandLevel);
        } finally {
    ...
    /**
     * Put method for updating an instance of Plantings identified by id using XML as the input format.
     *
     * @param id identifier for the entity
     * @param data an PlantingsConverter entity that is deserialized from a XML stream
     */
    @PUT
    @Consumes({"application/xml", "application/json"})
    public void put(PlantingsConverter data) {
        PersistenceService persistenceSvc = PersistenceService.getInstance();
        try {
            persistenceSvc.beginTx();
    ...
    /**
     * Delete method for deleting an instance of Plantings identified by id.
     *
     * @param id identifier for the entity
     */
    @DELETE
    ...
    /**
     * Returns an instance of Plantings identified by id.
     *
     * @param id identifier for the entity
     * @return an instance of Plantings
     */
    protected Plantings getEntity() {
        EntityManager em = PersistenceService.getInstance().getEntityManager();
        try {
            beans.PlantingsPK id = new beans.PlantingsPK(id1, id2);
            return (Plantings) em.createQuery("SELECT e FROM Plantings e where e.plantingsPK = :plantingsPK").setParameter("plantingsPK", id).getSingleResult();
     ...
     */
    private Plantings updateEntity(Plantings entity, Plantings newEntity) {
        EntityManager em = PersistenceService.getInstance().getEntityManager();
     ...
     */
    private void deleteEntity(Plantings entity) {
        EntityManager em = PersistenceService.getInstance().getEntityManager();
    ...
    public static class TreatmentsCollectionResourceSub extends TreatmentssResource {
        ...
        private Plantings parent;

        public void setParent(Plantings parent) {
            this.parent = parent;
        }
