...
public class SoilAnalysesLevelsResource {
    ...
    /**
     * Get method for retrieving a collection of SoilAnalysesLevel instance in XML format.
     *
    ...
    /**
     * Post method for creating an instance of SoilAnalysesLevel using XML as the input format.
     *
     * @param data an SoilAnalysesLevelConverter entity that is deserialized from an XML stream
     ...
     *
     * @return a collection of SoilAnalysesLevel instances
     */
