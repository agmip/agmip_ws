...
public class PlantingResource {
    ...
    /** Creates a new instance of PlantingResource */
    public PlantingResource() {
    }
    ...
    /**
     * Get method for retrieving an instance of Planting identified by id in XML format.
     *
    ...
    public PlantingConverter get(@QueryParam("expandLevel")
            @DefaultValue("1") int expandLevel) {
        PersistenceService persistenceSvc = PersistenceService.getInstance();
        try {
            persistenceSvc.beginTx();
            return new PlantingConverter(getEntity(), uriInfo.getAbsolutePath(), expandLevel);
        } finally {
    ...
    /**
     * Put method for updating an instance of Planting identified by id using XML as the input format.
     *
     * @param id identifier for the entity
     * @param data an PlantingConverter entity that is deserialized from a XML stream
     */
    @PUT
    @Consumes({"application/xml", "application/json"})
    public void put(PlantingConverter data) {
        PersistenceService persistenceSvc = PersistenceService.getInstance();
        try {
            persistenceSvc.beginTx();
    ...
    /**
     * Delete method for deleting an instance of Planting identified by id.
     *
     * @param id identifier for the entity
     */
    @DELETE
    ...
    /**
     * Returns an instance of Planting identified by id.
     *
     * @param id identifier for the entity
     * @return an instance of Planting
     */
     ...
     */
    private Planting updateEntity(Planting entity, Planting newEntity) {
        EntityManager em = PersistenceService.getInstance().getEntityManager();
     ...
     */
    private void deleteEntity(Planting entity) {
        EntityManager em = PersistenceService.getInstance().getEntityManager();
    ...
    public static class TreatmentsCollectionResourceSub extends TreatmentsResource {
        ...
        private Planting parent;

        public void setParent(Planting parent) {
            this.parent = parent;
        }
