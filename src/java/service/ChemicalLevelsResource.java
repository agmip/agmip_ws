...
public class ChemicalLevelsResource {
    ...
    /**
     * Get method for retrieving an instance of ChemicalLevels identified by id in XML format.
     *
    ...
    public ChemicalLevelsConverter get(@QueryParam("expandLevel")
            @DefaultValue("1") int expandLevel) {
        PersistenceService persistenceSvc = PersistenceService.getInstance();
        try {
            persistenceSvc.beginTx();
            return new ChemicalLevelsConverter(getEntity(), uriInfo.getAbsolutePath(), expandLevel);
        } finally {
    ...
    /**
     * Put method for updating an instance of ChemicalLevels identified by id using XML as the input format.
     *
     * @param id identifier for the entity
     * @param data an ChemicalLevelsConverter entity that is deserialized from a XML stream
     */
    @PUT
    @Consumes({"application/xml", "application/json"})
    public void put(ChemicalLevelsConverter data) {
        PersistenceService persistenceSvc = PersistenceService.getInstance();
        try {
            persistenceSvc.beginTx();
    ...
    /**
     * Delete method for deleting an instance of ChemicalLevels identified by id.
     *
     * @param id identifier for the entity
     */
    @DELETE
    ...
    /**
     * Returns an instance of ChemicalLevels identified by id.
     *
     * @param id identifier for the entity
     * @return an instance of ChemicalLevels
     */
    protected ChemicalLevels getEntity() {
        EntityManager em = PersistenceService.getInstance().getEntityManager();
        try {
            beans.ChemicalLevelsPK id = new beans.ChemicalLevelsPK(id1, id2);
            return (ChemicalLevels) em.createQuery("SELECT e FROM ChemicalLevels e where e.chemicalLevelsPK = :chemicalLevelsPK").setParameter("chemicalLevelsPK", id).getSingleResult();
     ...
     */
    private ChemicalLevels updateEntity(ChemicalLevels entity, ChemicalLevels newEntity) {
        EntityManager em = PersistenceService.getInstance().getEntityManager();
     ...
     */
    private void deleteEntity(ChemicalLevels entity) {
        EntityManager em = PersistenceService.getInstance().getEntityManager();
    ...
    public static class TreatmentsCollectionResourceSub extends TreatmentssResource {
        ...
        private ChemicalLevels parent;

        public void setParent(ChemicalLevels parent) {
            this.parent = parent;
        }
