...
public class EnvironModifLevelResource {
    ...
    protected EnvironModifLevel getEntity() {
        ...
        try {
            ...
            return (EnvironModifLevel) em.createQuery("SELECT e FROM EnvironModifLevel e where e.environModifLevelsPK = :environModifLevelsPK").setParameter("environModifLevelsPK", id).getSingleResult();
