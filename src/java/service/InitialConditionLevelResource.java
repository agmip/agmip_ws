...
public class InitialConditionLevelResource {
    ...
    /**
     * Get method for retrieving an instance of InitialConditionLevel identified by id in XML format.
     *
    ...
    /**
     * Put method for updating an instance of InitialConditionLevel identified by id using XML as the input format.
     *
     * @param id identifier for the entity
     * @param data an InitialConditionLevelConverter entity that is deserialized from a XML stream
     */
    @PUT
    ...
    /**
     * Delete method for deleting an instance of InitialConditionLevel identified by id.
     *
     * @param id identifier for the entity
     */
    @DELETE
    ...
    /**
     * Returns an instance of InitialConditionLevel identified by id.
     *
     * @param id identifier for the entity
     * @return an instance of InitialConditionLevel
     */
    protected InitialConditionLevel getEntity() {
        ...
        try {
            ...
            return (InitialConditionLevel) em.createQuery("SELECT e FROM InitialConditionLevel e where e.initialConditionLevelsPK = :initialConditionLevelsPK").setParameter("initialConditionLevelsPK", id).getSingleResult();
