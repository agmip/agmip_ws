...
public class TillageLevelConverter {
	...
	/**
	 * Getter for tillageEventsCollection.
	 *
	 * @return value for tillageEventsCollection
	 */
	@XmlElement
	public TillageEventsConverter getTillageEventsCollection() {
		if (expandLevel > 0) {
			if (entity.getTillageEventsCollection() != null) {
				return new TillageEventsConverter(entity.getTillageEventsCollection(), uri.resolve("tillageEventsCollection/"), expandLevel - 1);
			}
		}
		return null;
	}
	...
	/**
	 * Setter for tillageEventsCollection.
	 *
	 * @param value the value to set
	 */
	public void setTillageEventsCollection(TillageEventsConverter value) {
		entity.setTillageEventsCollection((value != null) ? value.getEntities() : null);
	}
	...
	public TillageLevel resolveEntity(EntityManager em) {
		...
		Collection<TillageEvent> newtillageEventsCollection = new java.util.ArrayList<TillageEvent>();
		if (tillageEventsCollection != null) {
			for (TillageEvent item : tillageEventsCollection) {
				newtillageEventsCollection.add(em.getReference(TillageEvent.class, item.getTillageEventPK()));
			}
		}
		entity.setTillageEventsCollection(newtillageEventsCollection);
