...
public class FieldConverter {
     ...
     */
    public FieldConverter(Field entity, URI uri, int expandLevel, boolean isUriExtendable) {
        this.entity = entity;
        this.uri = (isUriExtendable) ? UriBuilder.fromUri(uri).path(entity.getFieldPK().getExpId() + "," + entity.getFieldPK().getFl() + "/").build() : uri;
     ...
     */
    public FieldConverter(Field entity, URI uri, int expandLevel) {
    ...
    public FieldPK getFieldPK() {
        return (expandLevel > 0) ? entity.getFieldPK() : null;
    }
     ...
     */
    public void setFieldPK(FieldPK value) {
        entity.setFieldPK(value);
    }
    ...
    public Field getEntity() {
        if (entity.getFieldPK() == null) {
            FieldConverter converter = UriResolver.getInstance().resolve(FieldConverter.class, uri);
            if (converter != null) {
    ...
    /**
     * Returns the resolved Field entity.
     *
     * @return an resolved entity
     */
    public Field resolveEntity(EntityManager em) {
    ...
    public boolean equals(Object object) {
        if (!(object instanceof FieldConverter)) {
            return false;
        }
        FieldConverter other = (FieldConverter) object;
