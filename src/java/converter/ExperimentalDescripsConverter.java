 ...
 * @author wpavan
 */
@XmlRootElement(name = "experimentalDescrips")
public class ExperimentalDescripsConverter {
    private ExperimentalDescrips entity;
    private URI uri;
    private int expandLevel;

    /** Creates a new instance of ExperimentalDescripsConverter */
    public ExperimentalDescripsConverter() {
        entity = new ExperimentalDescrips();
    }
     ...
     */
    public ExperimentalDescripsConverter(ExperimentalDescrips entity, URI uri, int expandLevel, boolean isUriExtendable) {
        this.entity = entity;
     ...
     */
    public ExperimentalDescripsConverter(ExperimentalDescrips entity, URI uri, int expandLevel) {
    ...
    /**
     * Returns the ExperimentalDescrips entity.
     *
     * @return an entity
     */
    @XmlTransient
    public ExperimentalDescrips getEntity() {
        if (entity.getExpId() == null) {
            ExperimentalDescripsConverter converter = UriResolver.getInstance().resolve(ExperimentalDescripsConverter.class, uri);
            if (converter != null) {
    ...
    /**
     * Returns the resolved ExperimentalDescrips entity.
     *
     * @return an resolved entity
     */
    public ExperimentalDescrips resolveEntity(EntityManager em) {
    ...
    public boolean equals(Object object) {
        if (!(object instanceof ExperimentalDescripsConverter)) {
            return false;
        }
        ExperimentalDescripsConverter other = (ExperimentalDescripsConverter) object;
