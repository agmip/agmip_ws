...
public class InitialConditionLevelConverter {
	...
	public InitialConditionLevelConverter(InitialConditionLevel entity, URI uri, int expandLevel, boolean isUriExtendable) {
		...
		getInitialConditionEventsCollection();
	...
	/**
	 * Getter for initialConditionEventsCollection.
	 *
	 * @return value for initialConditionEventsCollection
	 */
	@XmlElement
	public InitialConditionEventsConverter getInitialConditionEventsCollection() {
		if (expandLevel > 0) {
			if (entity.getInitialConditionEventsCollection() != null) {
				return new InitialConditionEventsConverter(entity.getInitialConditionEventsCollection(), uri.resolve("initialConditionEventsCollection/"), expandLevel - 1);
			}
		}
		return null;
	}
	...
	/**
	 * Setter for initialConditionEventsCollection.
	 *
	 * @param value the value to set
	 */
	public void setInitialConditionEventsCollection(InitialConditionEventsConverter value) {
		entity.setInitialConditionEventsCollection((value != null) ? value.getEntities() : null);
	}
	...
	public InitialConditionLevel resolveEntity(EntityManager em) {
		...
		Collection<InitialConditionEvent> newinitialConditionEventsCollection = new java.util.ArrayList<InitialConditionEvent>();
		if (initialConditionEventsCollection != null) {
			for (InitialConditionEvent item : initialConditionEventsCollection) {
				newinitialConditionEventsCollection.add(em.getReference(InitialConditionEvent.class, item.getInitialConditionEventPK()));
			}
		}
		entity.setInitialConditionEventsCollection(newinitialConditionEventsCollection);
