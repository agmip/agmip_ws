...
public class SoilAnalysesLevelConverter {
	...
	public SoilAnalysesLevelConverter(SoilAnalysesLevel entity, URI uri, int expandLevel, boolean isUriExtendable) {
		...
		getSoilAnalysesEventsCollection();
	...
	/**
	 * Getter for soilAnalysesEventsCollection.
	 *
	 * @return value for soilAnalysesEventsCollection
	 */
	@XmlElement
	public SoilAnalysesEventsConverter getSoilAnalysesEventsCollection() {
		if (expandLevel > 0) {
			if (entity.getSoilAnalysesEventsCollection() != null) {
				return new SoilAnalysesEventsConverter(entity.getSoilAnalysesEventsCollection(), uri.resolve("soilAnalysesEventsCollection/"), expandLevel - 1);
			}
		}
		return null;
	}
	...
	/**
	 * Setter for soilAnalysesEventsCollection.
	 *
	 * @param value the value to set
	 */
	public void setSoilAnalysesEventsCollection(SoilAnalysesEventsConverter value) {
		entity.setSoilAnalysesEventsCollection((value != null) ? value.getEntities() : null);
	}
	...
	public SoilAnalysesLevel resolveEntity(EntityManager em) {
		...
		Collection<SoilAnalysesEvent> newsoilAnalysesEventsCollection = new java.util.ArrayList<SoilAnalysesEvent>();
		if (soilAnalysesEventsCollection != null) {
			for (SoilAnalysesEvent item : soilAnalysesEventsCollection) {
				newsoilAnalysesEventsCollection.add(em.getReference(SoilAnalysesEvent.class, item.getSoilAnalysesEventPK()));
			}
		}
		entity.setSoilAnalysesEventsCollection(newsoilAnalysesEventsCollection);
