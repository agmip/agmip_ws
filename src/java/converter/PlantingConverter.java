 ...
 * @author fonini
 */
@XmlRootElement(name = "planting")
public class PlantingConverter {
    private Planting entity;
    private URI uri;
    private int expandLevel;

    /** Creates a new instance of PlantingConverter */
    public PlantingConverter() {
        entity = new Planting();
    }
     ...
     */
    public PlantingConverter(Planting entity, URI uri, int expandLevel, boolean isUriExtendable) {
        this.entity = entity;
        this.uri = (isUriExtendable) ? UriBuilder.fromUri(uri).path(entity.getPlantingPK().getExpId() + "," + entity.getPlantingPK().getPl() + "/").build() : uri;
     ...
     */
    public PlantingConverter(Planting entity, URI uri, int expandLevel) {
        this(entity, uri, expandLevel, false);
    }

    /**
     * Getter for plantingPK.
     *
     * @return value for plantingPK
     */
    @XmlElement
    public PlantingPK getPlantingPK() {
        return (expandLevel > 0) ? entity.getPlantingPK() : null;
    }

    /**
     * Setter for plantingPK.
     *
     * @param value the value to set
     */
    public void setPlantingPK(PlantingPK value) {
        entity.setPlantingPK(value);
    }
    ...
    /**
     * Returns the Planting entity.
     *
     * @return an entity
     */
    @XmlTransient
    public Planting getEntity() {
        if (entity.getPlantingPK() == null) {
            PlantingConverter converter = UriResolver.getInstance().resolve(PlantingConverter.class, uri);
            if (converter != null) {
    ...
    /**
     * Returns the resolved Planting entity.
     *
     * @return an resolved entity
     */
    public Planting resolveEntity(EntityManager em) {
    ...
    public boolean equals(Object object) {
        if (!(object instanceof PlantingConverter)) {
            return false;
        }
        PlantingConverter other = (PlantingConverter) object;
